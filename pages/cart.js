                            ...
                            <Table>
                                ...
                                <tbody>
                                    ...
                                    <tr className="subtotal">
                                        <td colSpan={2}>Prece:</td>
                                        <td>€{productsTotal}</td>
                                    </tr>
                                    <tr className="subtotal">
                                        <td colSpan={2}>Piegāde:</td>
                                        <td>€{shippingFee}</td>
                                    </tr>
                    ...
                    {!!cartProducts?.length && (
                        ...
                        <Box>
                            <h2>Pasūtījuma info</h2>
                                ...
                                <Button gren block onClick={goToPayment}>Veikt Apmaksu</Button>
                        </Box>
                        </RevealWrapper>
                    )}
                </ColumnsWrapper>
